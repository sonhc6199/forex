...
if (mainNav !== null) {    
    ...
    if (signinEle !== null && signinEle.children.length > 0) {
        signinBtn = `<a href="${signinEle.children[0].children[0].href}" class="uk-button uk-button-primary uk-border-rounded uk-align-center">${signinEle.children[0].children[0].innerText}<i class="fas fa-sign-in-alt uk-margin-small-left"></i></a>`;
    }
